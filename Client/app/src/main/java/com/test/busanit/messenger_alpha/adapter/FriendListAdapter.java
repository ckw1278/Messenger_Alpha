...
public class FriendListAdapter extends BaseAdapter {
    ...
    public List<Member> friendList = new ArrayList<>();
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        byte[] bitmapData = friendList.get(position).getBitmapData();
        ...
        viewHolder.friendNick.setText(friendList.get(position).getNick());
        viewHolder.friendMsg.setText(friendList.get(position).getMsg());
        return convertView;
    }
